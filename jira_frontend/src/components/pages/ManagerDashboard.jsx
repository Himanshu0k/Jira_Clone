            ...
            <div className="w-1/3 bg-indigo-600 flex items-center justify-center p-10">
                <div>
                    ...
                    <p className="text-indigo-100 text-sm mt-2">
                        Manage tasks and oversee project progress
                    </p>
                </div>
            </div>
            ...
            <div className="w-2/3 bg-white flex flex-col items-center justify-start px-6 py-10 overflow-y-auto">
                <div className="w-full max-w-3xl bg-white/60 backdrop-blur-md border border-gray-200 rounded-3xl p-10 shadow-md hover:shadow-xl transition duration-500">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-500 mt-2 text-sm">Manage project issues and team tasks</p>
                    </div>

                    <div className="grid grid-cols-2 gap-6 mb-10">
                        <button
                            onClick={() => navigate("/create-issue")}
                            className="bg-indigo-600 text-white py-3 rounded-xl font-semibold hover:bg-indigo-700 transform hover:scale-105 transition-all duration-300"
                        >
                            ➕ Create New Issue
                        </button>
                        <button
                            onClick={() => navigate("/assign-issue")}
                            className="bg-yellow-500 text-white py-3 rounded-xl font-semibold hover:bg-yellow-600 transform hover:scale-105 transition-all duration-300"
                        >
                            👥 Assign Issue
                        </button>
                        <button
                            onClick={() => navigate("/view-issues")}
                            className="bg-pink-500 text-white py-3 rounded-xl font-semibold hover:bg-pink-600 transform hover:scale-105 transition-all duration-300"
                        >
                            🧾 View All Issues
                        </button>
                        <button
                            onClick={() => navigate("/admin/projects/delete")}
                            className="w-full bg-red-500 text-white py-3 rounded-xl font-semibold hover:bg-red-600 transform hover:scale-105 transition-all duration-300"
                        >
                            🗑️ Delete Project
                        </button>
                    </div>
